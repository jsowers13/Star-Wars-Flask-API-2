...
class Planets(db.Model):
    ...
    def serialize(self):
            return{
                "id": self.id,
                "name": self.name,
                "rotation_period": self.rotation.period,
...
class Starships(db.Model):
    ...
    hyperdrive_rating = db.Column(db.String(120), unique=False, nullable=False)
    MGLT = db.Column(db.String(120), unique=False, nullable=False)
